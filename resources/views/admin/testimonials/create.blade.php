    ...
    <div class="p-6">
        ...
        <form action="{{ route('testimonials.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="designation" value="{{ old('designation') }}" class="w-full p-2 border rounded"
                    placeholder="Eg. CEO, Nvidia">
            </div>

            <div class="mb-4">
                <label class="block mb-1 font-semibold">Name Initials</label>
                <input type="text" name="initials" value="{{ old('initials') }}" class="w-full p-2 border rounded"
                    maxlength="5" placeholder="Eg. JD for John Doe">
            </div>
            ...
            <button type="submit" class="bg-primary text-white px-4 py-2 rounded hover:bg-primary/90">Add
                Testimonial</button>
