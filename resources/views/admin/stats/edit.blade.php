...
@section('content')
    <div class="p-6">
        ...
        <h1 class="text-2xl font-bold text-primary mb-6">Edit Stat</h1>

        <form action="{{ route('stats.update', $stat->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            @method('PUT')
            ...
            <div class="flex space-x-2">
                <button type="submit"
                    class="px-4 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-primary/90">Update
                    Stat</button>
